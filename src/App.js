    ...
    <div className='relative w-full min-h-screen overflow-hidden flex flex-col justify-between items-center bg-amber-100'>
      ...
      <div className='relative w-full max-w-2xl z-10 my-10'>
        ...
        <div className='flex justify-center -mt-8'>
          <button onClick={generateJoke} disabled={loading} className={`bg-amber-400 text-red-800 leading-0 text-xl font-bold px-8 py-4 rounded-2xl shadow transition-all duration-100 animate__animated ${isAnimating ? 'animate__headShake' : 'animate__shakeX animate__delay-5s hover:bg-amber-300'}`} >
            { loading ? (
              <div className='flex items-center'>
                <p className='-mb-0.5'>TICKLE ME, NORRIS</p>
